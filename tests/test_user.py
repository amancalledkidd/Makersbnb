...
def test_user_initialises():
    user = User(1, 'Rikie Patrick', "rikie@gmail.com", "01234567890")
    assert user.id == 1
...
def test_users_are_equal():
    user1 = User(1, 'Rikie Patrick', "rikie@gmail.com", "01234567890")
    user2 = User(1, 'Rikie Patrick', "rikie@gmail.com", "01234567890")
    assert user1 == user2
